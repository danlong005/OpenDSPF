...
enum yysymbol_kind_t
{
  ...
  YYSYMBOL_KW_RECORD = 3,                  /* KW_RECORD  */
  YYSYMBOL_KW_END_RECORD = 4,              /* KW_END_RECORD  */
  YYSYMBOL_KW_LITERAL = 5,                 /* KW_LITERAL  */
  YYSYMBOL_KW_FIELD = 6,                   /* KW_FIELD  */
  YYSYMBOL_KW_KEY = 7,                     /* KW_KEY  */
  YYSYMBOL_KW_SCREEN = 8,                  /* KW_SCREEN  */
  YYSYMBOL_KW_TITLE = 9,                   /* KW_TITLE  */
  YYSYMBOL_KW_ROW = 10,                    /* KW_ROW  */
  YYSYMBOL_KW_COL = 11,                    /* KW_COL  */
  YYSYMBOL_KW_SIZE = 12,                   /* KW_SIZE  */
  YYSYMBOL_KW_INDICATOR = 13,              /* KW_INDICATOR  */
  YYSYMBOL_KW_COLOR = 14,                  /* KW_COLOR  */
  YYSYMBOL_KW_DSPATR = 15,                 /* KW_DSPATR  */
  YYSYMBOL_KW_TEXT = 16,                   /* KW_TEXT  */
  YYSYMBOL_KW_CHAR = 17,                   /* KW_CHAR  */
  YYSYMBOL_KW_ZONED = 18,                  /* KW_ZONED  */
  YYSYMBOL_KW_PACKED = 19,                 /* KW_PACKED  */
  YYSYMBOL_KW_INT = 20,                    /* KW_INT  */
  YYSYMBOL_KW_INPUT = 21,                  /* KW_INPUT  */
...
{
  "\"end of file\"", "error", "\"invalid token\"", "KW_RECORD",
...
yy_symbol_value_print (FILE *yyo,
                       yysymbol_kind_t yykind, YYSTYPE const * const yyvaluep, dspf::DspfFile* result)
{
  FILE *yyoutput = yyo;
  YY_USE (yyoutput);
  YY_USE (result);
...
yy_reduce_print (yy_state_t *yyssp, YYSTYPE *yyvsp,
                 int yyrule, dspf::DspfFile* result)
{
...
yydestruct (const char *yymsg,
            yysymbol_kind_t yykind, YYSTYPE *yyvaluep, dspf::DspfFile* result)
{
  YY_USE (yyvaluep);
  YY_USE (result);
  if (!yymsg)
